...
object UseFlows {
    ...
    class Initiator(
        ...
        override fun call(): SignedTransaction {
            ...
            if (casinoSession.counterparty != serviceHub.identityService
                            .requireWellKnownPartyFromAnonymous(casinoRef.state.data.creator))
            ...
            val builder = TransactionBuilder(playerRef.state.notary)
                    ...
                    .addCommand(Use(1), casinoRef.state.data.creator.owningKey)
